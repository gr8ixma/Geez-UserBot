...
async def hack(event):
    ...
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let'`")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's `")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's H`")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Ha`")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hac`")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack `")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack i`")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it `")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it .`")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ..`")
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...`")
    await asyncio.sleep(3)
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...\nroot@ixma:~# `")
    await asyncio.sleep(2)
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...\nroot@ixma:~# python setup.py`")
    await asyncio.sleep(2)
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...\nroot@ixma:~# python setup.py\n\nsetup.py deployed ...`")
    await asyncio.sleep(3)
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...\nroot@ixma:~# python setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...`")
    await asyncio.sleep(2)
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...\nroot@ixma:~# python setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@ixma:~# trap whoami`")
    await asyncio.sleep(3)
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...\nroot@ixma:~# python setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@ixma:~# trap whoami\n\nwhoami=user`")
    await asyncio.sleep(3)
    await event.edit("`root@ixma:~# ls\n\n  usr  ghost  codes  \n\nroot@ixma:~# # So Let's Hack it ...\nroot@ixma:~# python setup.py\n\nsetup.py deployed ...\nAuto CMD deployed ...\n\nroot@ixma:~# trap whoami\n\nwhoami=user\nboost_trap on force ...`")
